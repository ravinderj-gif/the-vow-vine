    ...
    <section id="contact" className="relative section-padding overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        <div ref={headerRef} className="text-center mb-16">
          ...
          <p className="mt-4 font-cormorant text-xl text-ivory/60">
          ...
          {contactItems.map((item, i) => {
            ...
            const content = (
              <motion.div
                ...
                className="glass-dark rounded-sm p-8 text-center hover:border-gold/30 transition-colors duration-500 group"
              >
                <Icon className="text-gold mx-auto mb-4 group-hover:scale-110 transition-transform" size={28} />
                <p className="text-xs uppercase tracking-[0.2em] text-ivory/40 font-poppins mb-2">
                  {item.label}
                </p>
                <p className="font-cormorant text-lg text-ivory">{item.value}</p>
              </motion.div>
            );
